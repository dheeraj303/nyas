...
const DigitalProductDevelopmentArea = () => {
  ...
  <link href="assets/assetssoftware/vendors/animate/animate.css" rel="stylesheet" />
  {/* Icon CSS*/}
  <link
    rel="stylesheet"
  ...
  />
  {/* Camera Slider */}
  <link rel="stylesheet" href="assets/assetssoftware/vendors/camera-slider/camera.css" />
  {/* Owlcarousel CSS*/}
  <link
    rel="stylesheet"
    type="text/css"
        ...
        <div className="container ">
          <div className="row">
            ...
            <div id="banner-text" className="col-md-7 text-c text-left ">
              <h5 className="wow fadeInUp main-h font_30" data-wow-delay="0.2s">
      ...
      <div className="row about_row">
        ...
        <div className="who_we_area col-md-4 col-sm-6 px_10 wow fadeInUp">
          <div className="service-about-services">
            ...
            <p>
              Crafting engaging, responsive websites tailored to reflect brand
              identity and meet unique business needs, enhancing user engagement
              and online presence.
            </p>
          </div>
        </div>
        ...
        <div className="who_we_area col-md-4 col-sm-6 px_10 wow fadeInUp">
          <div className="service-about-services text-left">
            ...
            <p>
              ...
              enabling businesses to validate ideas, attract stakeholders, and
        ...
        <div className="who_we_area col-md-4 col-sm-6 px_10 wow fadeInUp">
          <div className="service-about-services">
            ...
            <h2 className="unify_about"> UI/UX Design &amp; Prototyping </h2>
            <p>
      ...
      <div className="row mt_20">
        ...
        <div className="who_we_area col-md-4 col-sm-6 px_10 wow fadeInUp">
          <div className="service-about-services">
            ...
            <p>
              Providing continuous support and updates to ensure software and
              websites remain secure, optimized, and compatible with the latest
              technologies.
            </p>
          </div>
        </div>
        ...
        <div className="who_we_area col-md-4 col-sm-6 px_10 wow fadeInUp">
          <div className="service-about-services text-left">
            ...
            <p>
              Developing blockchain-powered applications, smart contracts, and
              secure, transparent systems tailored to meet modern business
              needs.
            </p>
          </div>
        </div>
            ...
            <div className="list-group">
              ...
              <a href="#" className="list-group-item">
                ...
                <p>
                  ...
                  validation helps in refining the product before committing to
                  full-scale development, saving time and resources.
                </p>
              </a>
              <a href="#" className="list-group-item">
                <img
                ...
                <p>
                  ...
                  which leads to higher user retention and satisfaction—critical
