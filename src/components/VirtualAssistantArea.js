        ...
        <div className="container text-center">
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <p data-aos="fade-up" data-aos-delay={100}>
              Transform operations with expert virtual assistance, enabling team
              focus on growth.
              <br />
            </p>
              ...
              <div className="service-item d-flex">
                ...
                <div>
                  ...
                  <p className="description">
                    Virtual assistants provide remote, varied support services.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="service-item d-flex">
                ...
                <div>
                  ...
                  <p className="description">
                    {" "}
                    VAs offer specialized, affordable services, reducing employee
                    expenses.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item d-flex">
                ...
                <div>
                  ...
                  <p className="description">
                    lexible hours help businesses focus on growth, productivity.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row gy-4">
            <div
              ...
              data-aos-delay={100}
            >
              <p className="who-we-are">Empowering Your Business for Growth</p>
              <h3>Transform Your Business Operations</h3>
              <p className="fst-italic">
                An exceptional virtual assistant service by Nyas Consultants will
                revolutionize how your business operates daily. By outsourcing
                time-consuming or specialized tasks such as web design, SEO
                research, digital marketing, data analytics, and more, companies
                can redirect focus towards growth, reduce operational costs, and
                enhance team flexibility. At Nyas Consultants, we provide a
                comprehensive suite of virtual assistant services designed to
                streamline your business processes and empower you to achieve your
              ...
              <ul>
                <li>
                  ...
                  <span>
                    {" "}
                    Outsource specialized tasks to focus on growth and innovation.
                  </span>
                </li>
                <li>
                  <i className="bi bi-check-circle" />{" "}
                  <span>
                    {" "}
                    Reduce operational costs while boosting team flexibility and
                    productivity.
                  </span>
                </li>
                <li>
                  ...
                  <span>
                    {" "}
                    Streamline processes with tailored virtual assistant services.
                  </span>
                </li>
                <li>
                  <i className="bi bi-check-circle" />{" "}
          ...
          <div className="row g-5">
              ...
              <div className="service-item item-cyan position-relative">
                ...
                <div>
                  ...
                  <p>
                    ...
                    specifically for your business. Whether building a new site or
                    optimizing an existing one, our web design experts are here to
                    assist.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay={300}>
              <div className="service-item item-teal position-relative">
                <i className="bi bi-bar-chart-line icon" /> {/* Changed Icon */}
                <div>
                  <h3>Digital Marketing</h3>
                  <p>
                    Our digital marketing solutions, including SEO/SMM, PPC, and
                    content marketing, put your business in front of the right
                    audience. Let us create a strategy that drives traffic and
                    leads to your site.
                  </p>
                </div>
              </div>
              ...
              <div className="service-item item-indigo position-relative">
                ...
                <div>
                  ...
                  <p>
                    ...
                    working with us. They can provide targeted SEO services, from
                    link building to keyword optimization, helping you rank higher
            ...
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay={600}>
              <div className="service-item item-pink position-relative">
                ...
                <div>
                  ...
                  <p>
                    Our software development team specializes in building custom
                    applications tailored to your business needs, ensuring smooth
              ...
              <div className="row">
                ...
                <div className="col-lg-6 icon-box d-flex">
                  ...
                  <div>
                    <h4>Key Tasks</h4>
                    <p>
                      Research market, find leads, schedule meetings, and manage
                      emails.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-6 icon-box d-flex">
                  ...
                  <div>
                    ...
                    <p>
                      VAs enhance operations, contributing to business growth and
                      efficiency.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-10" data-aos="fade-up" data-aos-delay={100}>
              <div className="faq-container">
                <div className="faq-item faq-active">
                  <h3>What services do virtual assistants at NYAS provide?</h3>
                ...
                <div className="faq-item">
                  <h3>How can hiring a virtual assistant help my business?</h3>
                  <div className="faq-content">
                    <p>
                ...
                {/* End Faq item*/}
                <div className="faq-item">
                  <h3>How does the pricing for NYAS Assistant services work?</h3>
                  <div className="faq-content">
                    <p>
